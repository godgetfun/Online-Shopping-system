 ...
 * @author Vam
 */
public class Mobilecat extends javax.swing.JFrame {
    ...
    int y,x;
    String b;
    public String b1,b2,b3,b4,b5;
    public String sq1,sq2,sq3,sq4,sq5;
    /*DatabaseConnection con_16 = new DatabaseConnection();
    Statement s;
    ResultSet rs;*/
    public Mobilecat() throws SQLException, ClassNotFoundException {   
     // NOI18N
            ...
            Connection c;
                ...
                while(rs.next()){
                       ...
                       // jLabel26 = new javax.swing.JLabel();
                        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource(b)));
                        b2=rs.getString(7);
                        sq2 = "insert into cart values( '"+rs.getString(1)+"','"+rs.getString(2)+"' ,'"+rs.getString(3)+"' ,'"+rs.getString(4)+"', '"+rs.getString(5)+"', '"+rs.getString(6)+"')";
...
// Code adding the component to the parent container - not shown here
                        ...
                        if(x>=2 && (x>=y)){
                            ...
                            b=rs.getString(6);
                             ...
                             b1=rs.getString(7);
                            sq1 = "insert into cart values( '"+rs.getString(1)+"','"+rs.getString(2)+"' ,'"+rs.getString(3)+"' ,'"+rs.getString(4)+"', '"+rs.getString(5)+"', '"+rs.getString(6)+"')";
                            ...
                            if(x>=3 && (x>=y)){
                               ...
                               // jLabel17 = new javax.swing.JLabel();
                                ...
                                b5=rs.getString(7);
                                sq5 = "insert into cart values( '"+rs.getString(1)+"','"+rs.getString(2)+"' ,'"+rs.getString(3)+"' ,'"+rs.getString(4)+"', '"+rs.getString(5)+"', '"+rs.getString(6)+"')";
                                ...
                                if(x>=4 && (x>=y)){
                                    ...
                                    b3=rs.getString(7);
                                    sq3 = "insert into cart values( '"+rs.getString(1)+"','"+rs.getString(2)+"' ,'"+rs.getString(3)+"' ,'"+rs.getString(4)+"', '"+rs.getString(5)+"', '"+rs.getString(6)+"')";
                                    ...
                                    if(x>=5 && (x>=y)){
                                       ...
                                       // jLabel25 = new javax.swing.JLabel();
                                        ...
                                        b4=rs.getString(7);
                                        sq4 = "insert into cart values( '"+rs.getString(1)+"','"+rs.getString(2)+"' ,'"+rs.getString(3)+"' ,'"+rs.getString(4)+"', '"+rs.getString(5)+"', '"+rs.getString(6)+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mobilecat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
