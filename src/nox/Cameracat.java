 ...
 * @author Vam
 */
public class Cameracat extends javax.swing.JFrame {
    ...
    Statement s;
    ResultSet rs;*/
    public Cameracat() throws SQLException, ClassNotFoundException {   
     // NOI18N
...
// Code adding the component to the parent container - not shown here
            ...
            Logger.getLogger(Cameracat.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cameracat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
